...
var canvas, canvasDOM, ctx, drawRotatedRect, getRandomSize;
...
getRandomSize = function(num) {
  return Math.max(num / 20, (Math.random() * num) / 2);
};

export var drawRectangleRandomly = function(color) {
  var cHeight, cWidth, ranHeight, ranRotation, ranWidth, ranX, ranY;
  ({
    width: cWidth,
    height: cHeight
  } = canvas);
